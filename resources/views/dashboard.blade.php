                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">56</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Chào mừng đến với S-MIS!</h4>
                            </div>
                            <div class="card-body">
                                <p>Bạn đã đăng nhập thành công vào hệ thống quản lý sinh viên.</p>
                                <p class="mb-0">Vai trò: <span class="badge bg-primary">{{ Auth::user()->name }}</span>
                                </p>
                            </div>
                        </div>
                    </div>
