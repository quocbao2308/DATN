...
@section('title', 'Sửa Chương trình khung')
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Sửa Chương trình khung</h3>
                    <p class="text-subtitle text-muted">Cập nhật thông tin chương trình khung</p>
                </div>
            </div>
        </div>
                                    ...
                                    <select name="chuyen_nganh_id" id="chuyen_nganh_id"
                                        ...
                                        @foreach ($chuyenNganhs as $chuyenNganh)
                                            <option value="{{ $chuyenNganh->id }}"
                                                {{ old('chuyen_nganh_id', $chuongTrinhKhung->chuyen_nganh_id) == $chuyenNganh->id ? 'selected' : '' }}>
                                    ...
                                    <select name="mon_hoc_id" id="mon_hoc_id"
                                        ...
                                        @foreach ($monHocs as $monHoc)
                                            <option value="{{ $monHoc->id }}"
                                                {{ old('mon_hoc_id', $chuongTrinhKhung->mon_hoc_id) == $monHoc->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="loai_mon_hoc" id="loai_mon_hoc"
                                        ...
                                        <option value="Bắt buộc"
                                            {{ old('loai_mon_hoc', $chuongTrinhKhung->loai_mon_hoc) == 'Bắt buộc' ? 'selected' : '' }}>
                                            Bắt buộc
                                        </option>
                                        <option value="Chuyên ngành bắt buộc"
                                            {{ old('loai_mon_hoc', $chuongTrinhKhung->loai_mon_hoc) == 'Chuyên ngành bắt buộc' ? 'selected' : '' }}>
                                            Chuyên ngành bắt buộc
                                        </option>
                                        <option value="Tự chọn"
                                            {{ old('loai_mon_hoc', $chuongTrinhKhung->loai_mon_hoc) == 'Tự chọn' ? 'selected' : '' }}>
                                            Tự chọn
                                        </option>
                                    </select>
                                    @error('loai_mon_hoc')
