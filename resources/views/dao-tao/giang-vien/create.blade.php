    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dao-tao.giang-vien.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="ma_giang_vien" id="ma_giang_vien" 
                                        ...
                                        value="{{ old('ma_giang_vien') }}" required>
                                    @error('ma_giang_vien')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="trinh_do_id" id="trinh_do_id" 
                                        ...
                                        @foreach($trinhDos as $td)
                                            <option value="{{ $td->id }}" {{ old('trinh_do_id') == $td->id ? 'selected' : '' }}>
                                                {{ $td->ten_trinh_do }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="chuyen_mon" id="chuyen_mon" rows="3"
                                        class="form-control @error('chuyen_mon') is-invalid @enderror">{{ old('chuyen_mon') }}</textarea>
                                    @error('chuyen_mon')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('anh_dai_dien')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Định dạng: JPG, PNG, JPEG (Max 2MB)</small>
                                </div>
                            </div>
                        </div>
