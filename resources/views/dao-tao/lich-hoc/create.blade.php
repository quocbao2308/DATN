    ...
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dao-tao.lich-hoc.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="hinh_thuc_buoi_hoc" id="hinh_thuc_buoi_hoc"
                                        ...
                                        <option value="offline" {{ old('hinh_thuc_buoi_hoc') == 'offline' ? 'selected' : '' }}>Offline</option>
                                        <option value="online" {{ old('hinh_thuc_buoi_hoc') == 'online' ? 'selected' : '' }}>Online</option>
                                        <option value="hybrid" {{ old('hinh_thuc_buoi_hoc') == 'hybrid' ? 'selected' : '' }}>Kết hợp</option>
                                    </select>
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="giang_vien_phu_trach" class="form-select">
                                        ...
                                        @foreach($giangViens as $gv)
                                            <option value="{{ $gv->id }}" {{ old('giang_vien_phu_trach') == $gv->id ? 'selected' : '' }}>
                                                {{ $gv->ho_ten }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="ghi_chu" id="ghi_chu" class="form-control" value="{{ old('ghi_chu') }}">
                                </div>
                            </div>
                        </div>
