...
<div class="container mt-4">
    ...
    <form action="{{ route('dao-tao.lop-hoc-phan.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="ma_lop_hp" id="ma_lop_hp" class="form-control" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="suc_chua" id="suc_chua" class="form-control" placeholder="Nhập số lượng tối đa">
        </div>

        {{-- Ghi chú --}}
        <div class="mb-3">
            <label for="ghi_chu" class="form-label">Ghi chú</label>
            <textarea name="ghi_chu" id="ghi_chu" rows="3" class="form-control"></textarea>
        </div>
