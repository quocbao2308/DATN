            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('dao-tao.chuyen-nganh.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @forelse($chuyenNganhs as $index => $chuyenNganh)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('dao-tao.chuyen-nganh.edit', $chuyenNganh->id) }}"
                                                class="btn btn-sm btn-warning">
                                                <i class="bi bi-pencil"></i>
                                            </a>
                                            <form action="{{ route('dao-tao.chuyen-nganh.destroy', $chuyenNganh->id) }}"
