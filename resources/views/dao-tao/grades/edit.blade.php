...
<div class="page-heading">
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6"><h3>Cập nhật điểm</h3></div>
        </div>
    </div>
<!-- Ghí chsu quản lý đểm  -->
    <section class="section">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('dao-tao.grades.update', $grade->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="sinh_vien_id" id="sinh_vien_id" class="form-select @error('sinh_vien_id') is-invalid @enderror" required>
                                ...
                                @foreach($sinhViens as $sv)
                                    <option value="{{ $sv->id }}" {{ old('sinh_vien_id', $grade->sinh_vien_id) == $sv->id ? 'selected' : '' }}>
                                        {{ $sv->ho_ten }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="mon_hoc_id" id="mon_hoc_id" class="form-select @error('mon_hoc_id') is-invalid @enderror" required>
                                ...
                                @foreach($monHocs as $mon)
                                    <option value="{{ $mon->id }}" {{ old('mon_hoc_id', $grade->mon_hoc_id) == $mon->id ? 'selected' : '' }}>
                                        {{ $mon->ten_mon }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01" min="0" max="10" name="diem_qua_trinh" id="diem_qua_trinh"
                                class="form-control @error('diem_qua_trinh') is-invalid @enderror"
                                value="{{ old('diem_qua_trinh', $grade->diem_qua_trinh) }}">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01" min="0" max="10" name="diem_thi" id="diem_thi"
                                class="form-control @error('diem_thi') is-invalid @enderror"
                                value="{{ old('diem_thi', $grade->diem_thi) }}">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01" min="0" max="10" name="diem_tong_ket" id="diem_tong_ket"
                                class="form-control @error('diem_tong_ket') is-invalid @enderror"
                                value="{{ old('diem_tong_ket', $grade->diem_tong_ket) }}">
