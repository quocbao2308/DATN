        ...
        <section class="section">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Chỉnh sửa: {{ $monHoc->ten_mon }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('dao-tao.mon-hoc.update', $monHoc->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="so_tin_chi" id="so_tin_chi"
                                    ...
                                    value="{{ old('so_tin_chi', $monHoc->so_tin_chi) }}" min="1" max="10"
                                    required>
                                @error('so_tin_chi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="loai_mon" id="loai_mon"
                                    ...
                                    value="{{ old('loai_mon', $monHoc->loai_mon) }}" required>
                                @error('loai_mon')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="hinh_thuc_day" id="hinh_thuc_day"
                                    ...
                                    @foreach (\App\Constants\SystemConstants::TEACHING_MODES as $key => $label)
                                        <option value="{{ $key }}"
                                            {{ old('hinh_thuc_day', $monHoc->hinh_thuc_day) == $key ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="thoi_luong" id="thoi_luong"
                                    ...
                                    value="{{ old('thoi_luong', $monHoc->thoi_luong) }}" min="0">
                                @error('thoi_luong')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="so_buoi" id="so_buoi"
                                    ...
                                    value="{{ old('so_buoi', $monHoc->so_buoi) }}" min="0">
                                @error('so_buoi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="mo_ta" id="mo_ta" rows="3" class="form-control @error('mo_ta') is-invalid @enderror">{{ old('mo_ta', $monHoc->mo_ta) }}</textarea>
                                @error('mo_ta')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="card">
                                    <div class="card-body" style="max-height: 300px; overflow-y: auto;">
                                        @php
                                            $currentTienQuyet = old(
                                                'mon_tien_quyet_ids',
                                                $monHoc->monTienQuyets->pluck('id')->toArray(),
                                            );
                                        @endphp
                                        @forelse($allMonHocs as $mon)
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                    ...
                                                    id="mon_{{ $mon->id }}"
                                                    {{ in_array($mon->id, $currentTienQuyet) ? 'checked' : '' }}>
