            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('dao-tao.phong-hoc.create') }}" class="btn btn-primary"><i
                        ...
                        <tbody>
                            @forelse($phongHocs as $index => $phong)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('dao-tao.phong-hoc.edit', $phong->id) }}"
                                                class="btn btn-sm btn-warning"><i class="bi bi-pencil"></i></a>
                                            <form action="{{ route('dao-tao.phong-hoc.destroy', $phong->id) }}"
