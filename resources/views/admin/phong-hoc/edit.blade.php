...
@section('content')
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.phong-hoc.update', $phongHoc->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('ma_phong') is-invalid @enderror"
                                        name="ma_phong" value="{{ old('ma_phong', $phongHoc->ma_phong) }}" required>
                                    @error('ma_phong')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('ten_phong') is-invalid @enderror"
                                        name="ten_phong" value="{{ old('ten_phong', $phongHoc->ten_phong) }}" required>
                                    @error('ten_phong')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('suc_chua') is-invalid @enderror"
                                        name="suc_chua" value="{{ old('suc_chua', $phongHoc->suc_chua) }}" min="1"
                                        max="1000" required>
                                    @error('suc_chua')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('vi_tri') is-invalid @enderror" name="vi_tri"
                                value="{{ old('vi_tri', $phongHoc->vi_tri) }}">
                            @error('vi_tri')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('mo_ta') is-invalid @enderror" name="mo_ta" rows="3">{{ old('mo_ta', $phongHoc->mo_ta) }}</textarea>
                            @error('mo_ta')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
