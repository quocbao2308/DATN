            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.khoa.create') }}" class="btn btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <form action="{{ route('admin.khoa.destroy', $khoa->id) }}" method="POST"
                                                class="d-inline"
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted">
                                        ...
                                        <p>Chưa có khoa nào. <a href="{{ route('admin.khoa.create') }}">Thêm mới</a></p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
