            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('admin.hoc-ky.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @forelse($hocKys as $index => $hocKy)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('admin.hoc-ky.edit', $hocKy->id) }}"
                                                class="btn btn-sm btn-warning">
                                                <i class="bi bi-pencil"></i>
                                            </a>
                                            <form action="{{ route('admin.hoc-ky.destroy', $hocKy->id) }}" method="POST"
