            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.nganh.create') }}" class="btn btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('admin.nganh.edit', $nganh->id) }}"
                                                class="btn btn-sm btn-warning">
                                                <i class="bi bi-pencil-square"></i>
                                            </a>
                                            <form action="{{ route('admin.nganh.destroy', $nganh->id) }}" method="POST"
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted">
                                        Chưa có ngành nào. <a href="{{ route('admin.nganh.create') }}">Thêm mới</a>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                    <div class="mt-3">{{ $nganhs->links() }}</div>
                </div>
            </div>
        </section>
    </div>
