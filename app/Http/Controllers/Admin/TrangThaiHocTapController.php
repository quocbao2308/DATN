...
use App\Models\System\TrangThaiHocTap;
...
class TrangThaiHocTapController extends Controller
{
    ...
    {
        return view('admin.trang-thai-hoc-tap.create');
    }
    ...
    public function show(TrangThaiHocTap $trangThai)
    {
        ...
        return view('admin.trang-thai-hoc-tap.show', compact('trangThai'));
    }
    ...
    {
        return view('admin.trang-thai-hoc-tap.edit', compact('trangThai'));
    }
