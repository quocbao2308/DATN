...
class HocKyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dao-tao.hoc-ky.index', compact('hocKys'));
    }
    ...
    public function create()
    {
        ...
        return view('dao-tao.hoc-ky.create', compact('khoaHocs'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('dao-tao.hoc-ky.show', compact('hocKy'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $khoaHocs = KhoaHoc::orderBy('nam_bat_dau', 'desc')->get();
        return view('dao-tao.hoc-ky.edit', compact('hocKy', 'khoaHocs'));
    }
