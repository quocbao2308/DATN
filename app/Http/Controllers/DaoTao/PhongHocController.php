...
class PhongHocController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dao-tao.phong-hoc.index', compact('phongHocs'));
    }
    ...
    {
        return view('dao-tao.phong-hoc.create');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('dao-tao.phong-hoc.show', compact('phongHoc'));
    }
    ...
    {
        $phongHoc = PhongHoc::findOrFail($id);
        return view('dao-tao.phong-hoc.edit', compact('phongHoc'));
    }
