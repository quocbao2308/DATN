...
class ChuyenNganhController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dao-tao.chuyen-nganh.index', compact('chuyenNganhs'));
    }
    ...
    public function create()
    {
        ...
        return view('dao-tao.chuyen-nganh.create', compact('khoas', 'nganhs'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('dao-tao.chuyen-nganh.index')
    ...
    public function show(ChuyenNganh $chuyenNganh)
    {
        ...
        return view('dao-tao.chuyen-nganh.show', compact('chuyenNganh'));
    }
    ...
    public function edit(ChuyenNganh $chuyenNganh)
    {
        $khoas = Khoa::with('nganhs')->orderBy('ten_khoa')->get();
        $nganhs = Nganh::with('khoa')->orderBy('ten_nganh')->get();
        return view('dao-tao.chuyen-nganh.edit', compact('chuyenNganh', 'khoas', 'nganhs'));
    }
