...
class DmTrinhDoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dao-tao.trinh-do.index', compact('trinhDos'));
    }
    ...
    {
        return view('dao-tao.trinh-do.create');
    }
    ...
    public function show(DmTrinhDo $trinhDo)
    {
        ...
        return view('dao-tao.trinh-do.show', compact('trinhDo'));
    }
    ...
    {
        return view('dao-tao.trinh-do.edit', compact('trinhDo'));
    }
