...
class KhoaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dao-tao.khoa.index', compact('khoas'));
    }
    ...
    {
        return view('dao-tao.khoa.create');
    }
    ...
    public function show(Khoa $khoa)
    {
        ...
        return view('dao-tao.khoa.show', compact('khoa'));
    }
    ...
    {
        return view('dao-tao.khoa.edit', compact('khoa'));
    }
